...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.scoresheet'
        db.add_column(u'ask_question', 'scoresheet',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['signalbox.ScoreSheet'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.scoresheet'
        db.delete_column(u'ask_question', 'scoresheet_id')
