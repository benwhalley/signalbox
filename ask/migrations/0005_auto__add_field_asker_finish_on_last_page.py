...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asker.finish_on_last_page'
        db.add_column(u'ask_asker', 'finish_on_last_page',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Asker.finish_on_last_page'
        db.delete_column(u'ask_asker', 'finish_on_last_page')
