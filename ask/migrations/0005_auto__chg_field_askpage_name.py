...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AskPage.name'
        db.alter_column(u'ask_askpage', 'name', self.gf('django.db.models.fields.CharField')(default='Page', max_length=255))

    def backwards(self, orm):

        # Changing field 'AskPage.name'
        db.alter_column(u'ask_askpage', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
