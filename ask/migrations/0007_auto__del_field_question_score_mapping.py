...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.score_mapping'
        db.delete_column(u'ask_question', 'score_mapping')


    def backwards(self, orm):
        # Adding field 'Question.score_mapping'
        db.add_column(u'ask_question', 'score_mapping',
