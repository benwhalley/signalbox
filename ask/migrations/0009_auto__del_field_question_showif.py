...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.showif'
        db.delete_column(u'ask_question', 'showif_id')


    def backwards(self, orm):
        # Adding field 'Question.showif'
        db.add_column(u'ask_question', 'showif',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ask.ShowIf'], null=True, blank=True),
                      keep_default=False)
