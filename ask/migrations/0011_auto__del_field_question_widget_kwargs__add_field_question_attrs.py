...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.widget_kwargs'
        db.rename_column(u'ask_question', 'widget_kwargs', 'extra_attrs')


    def backwards(self, orm):
        # Adding field 'Question.widget_kwargs'
        db.rename_column(u'ask_question', 'extra_attrs', 'widget_kwargs')
    ...
    models = {
        ...
        'ask.question': {
            ...
            'attrs': ('jsonfield.fields.JSONField', [], {'default': "'{}'"}),
            'choiceset': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ask.ChoiceSet']", 'null': 'True', 'blank': 'True'}),
