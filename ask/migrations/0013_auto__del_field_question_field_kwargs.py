...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.field_kwargs'
        db.delete_column(u'ask_question', 'field_kwargs')


    def backwards(self, orm):
        # Adding field 'Question.field_kwargs'
        db.add_column(u'ask_question', 'field_kwargs',
