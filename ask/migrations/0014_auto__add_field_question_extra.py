...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.extra'
        db.add_column(u'ask_question', 'extra',
                      self.gf('yamlfield.fields.YAMLField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.extra'
        db.delete_column(u'ask_question', 'extra')
    ...
    models = {
        ...
        'ask.question': {
            ...
            'choiceset': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ask.ChoiceSet']", 'null': 'True', 'blank': 'True'}),
            'extra': ('yamlfield.fields.YAMLField', [], {'blank': 'True'}),
            'extra_attrs': ('jsonfield.fields.JSONField', [], {'default': "'{}'"}),
