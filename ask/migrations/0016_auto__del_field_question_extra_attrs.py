...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.extra_attrs'
        db.delete_column(u'ask_question', 'extra_attrs')


    def backwards(self, orm):
        # Adding field 'Question.extra_attrs'
        db.add_column(u'ask_question', 'extra_attrs',
