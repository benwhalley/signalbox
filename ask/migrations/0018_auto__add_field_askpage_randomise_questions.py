...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AskPage.randomise_questions'
        db.add_column(u'ask_askpage', 'randomise_questions',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AskPage.randomise_questions'
        db.delete_column(u'ask_askpage', 'randomise_questions')
    ...
    models = {
        'ask.asker': {
            ...
            'system_audio': ('yamlfield.fields.YAMLField', [], {'blank': 'True'})
        },
        'ask.askpage': {
            ...
            'randomise_questions': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'ask.question': {
            ...
            'choiceset': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ask.ChoiceSet']", 'null': 'True', 'blank': 'True'}),
            'extra_attrs': ('yamlfield.fields.YAMLField', [], {'blank': 'True'}),
