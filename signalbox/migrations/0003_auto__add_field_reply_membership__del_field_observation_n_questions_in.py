...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reply.membership'
        db.add_column(u'signalbox_reply', 'membership',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['signalbox.Membership'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Observation.n_questions_incomplete'
        db.delete_column(u'signalbox_observation', 'n_questions_incomplete')


    def backwards(self, orm):
        # Deleting field 'Reply.membership'
        db.delete_column(u'signalbox_reply', 'membership_id')

        # Adding field 'Observation.n_questions_incomplete'
        db.add_column(u'signalbox_observation', 'n_questions_incomplete',
