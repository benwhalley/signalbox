...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field ad_hoc_askers on 'Study'
        m2m_table_name = db.shorten_name(u'signalbox_study_ad_hoc_askers')
        ...
        db.create_unique(m2m_table_name, ['study_id', 'asker_id'])


    def backwards(self, orm):
        # Removing M2M table for field ad_hoc_askers on 'Study'
        db.delete_table(db.shorten_name(u'signalbox_study_ad_hoc_askers'))
