...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Reply.twilio_question_index'
        db.delete_column(u'signalbox_reply', 'twilio_question_index')


    def backwards(self, orm):
        # Adding field 'Reply.twilio_question_index'
        db.add_column(u'signalbox_reply', 'twilio_question_index',
