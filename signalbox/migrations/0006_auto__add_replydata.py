...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReplyData'
        db.create_table(u'signalbox_replydata', (
        ...
        db.send_create_signal('signalbox', ['ReplyData'])


    def backwards(self, orm):
        # Deleting model 'ReplyData'
        db.delete_table(u'signalbox_replydata')
