...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reply.token'

        # except we don't do this to enable backwards compatibility
        pass
        # db.alter_column(u'signalbox_reply', 'token', self.gf('shortuuidfield.fields.ShortUUIDField')(max_length=22))

    def backwards(self, orm):

        # Changing field 'Reply.token'
        pass
        # db.alter_column(u'signalbox_reply', 'token', self.gf('django.db.models.fields.CharField')(max_length=36))
