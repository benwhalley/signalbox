...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Observation.token'
        # except we don't to preseve backwards compat.. see also 0007
        pass
        # db.alter_column(u'signalbox_observation', 'token', self.gf('shortuuidfield.fields.ShortUUIDField')(max_length=22))

    def backwards(self, orm):

        # Changing field 'Observation.token'
        pass
        # db.alter_column(u'signalbox_observation', 'token', self.gf('django.db.models.fields.CharField')(max_length=36))
