...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Study.allocation_method'
        db.delete_column(u'signalbox_study', 'allocation_method')


        # Changing field 'Study.randomisation_probability'
        db.alter_column(u'signalbox_study', 'randomisation_probability', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1))

    def backwards(self, orm):
        # Adding field 'Study.allocation_method'
        db.add_column(u'signalbox_study', 'allocation_method',
                      self.gf('django.db.models.fields.CharField')(default='balanced_groups_adaptive_randomisation', max_length=85),
                      keep_default=False)


        # Changing field 'Study.randomisation_probability'
        db.alter_column(u'signalbox_study', 'randomisation_probability', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=2, decimal_places=1))
    ...
    models = {
        ...
        'signalbox.observation': {
            ...
            'token': ('shortuuidfield.fields.ShortUUIDField', [], {'max_length': '22', 'blank': 'True'})
        },
        ...
        'signalbox.reply': {
            ...
            'membership': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['signalbox.Membership']", 'null': 'True', 'blank': 'True'}),
        ...
        'signalbox.study': {
            ...
            'ad_hoc_askers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['ask.Asker']", 'null': 'True', 'blank': 'True'}),
            ...
            'randomisation_probability': ('django.db.models.fields.DecimalField', [], {'default': '0.5', 'max_digits': '2', 'decimal_places': '1'}),
